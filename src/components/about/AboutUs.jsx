    ...
    return (
        <div className="about">
            ...
            <div className="shortDes">
                <div className="col-12" style={{ letterSpacing: 1.2, lineHeight: 1.8 }}><span style={{ fontSize: 36, lineHeight: 0 }}>H</span>
                ...
                <div className="shortDes1">
                    <div className="row">
                        <div className="col-6" style={{ letterSpacing: 1.2, lineHeight: 1.8, paddingRight: 30, paddingBottom: 30 }}><span style={{ fontSize: 36, lineHeight: 0 }}>X</span>
                        ...
                        <div className="col-6" style={{ letterSpacing: 1.2, lineHeight: 1.8, paddingLeft: 30, paddingBottom: 30 }}><span style={{ fontSize: 36, lineHeight: 0 }}>"T</span>

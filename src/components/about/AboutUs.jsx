...
function AboutUs() {
    return (
        <div className="about">
            ...
            <div className="aDes" style={{ letterSpacing: 1.4, lineHeight: 1.6, paddingTop: 10 }}> <span style={{ fontSize: 42, lineHeight: 0 }}>"</span> Nếu bạn muốn đi nhanh, hãy đi một mình. Nếu bạn muốn đi xa, hãy đi cùng Car World ”</div>
            <div className="aboutUs"><span className="hl11">Về</span> chúng tôi</div>
            <div className="shortDes">
                <div className="col-12" style={{ letterSpacing: 1.2, lineHeight: 1.8, fontSize: 16 }}><span style={{ fontSize: 36, lineHeight: 0 }}>H</span>
                ...
                <div className="shortDes1">
                    <div className="row">
                        <div className="col-6" style={{ letterSpacing: 1.2, lineHeight: 1.8, paddingRight: 30, paddingBottom: 30, fontSize: 16  }}><span style={{ fontSize: 36, lineHeight: 0 }}>X</span>
                        ...
                        <div className="col-6" style={{ letterSpacing: 1.2, lineHeight: 1.8, paddingLeft: 30, paddingBottom: 30, fontSize: 16  }}><span style={{ fontSize: 36, lineHeight: 0 }}>"T</span>
